...
var startLatLon = new coord(_.startLat._startLon)
...
exports.convertLinksToDistance = function(numberOfLinks){
	console.log('IN Coords.js, numberOfLinks: ' + numberOfLinks + ' linkDistance: ' + _.linkDistance + ' result '+ (numberOfLinks * _.linkDistance))
